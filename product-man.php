...
<html>
  ...
  <body>
    ...
    <form name="Add New Student" action="product-add.php" method="post"> 
      Product ID (16 digits):<input type="text" name="product_id" value="3000111122223348"> <br/>
      Type: <input type="text" name="type"> <br/>
      Name: <input type="text" name="name"> <br/>
      Series: <input type="text" name="series"> <br/>
      Buying Price: <input type="text" name="buying_price"> <br/>
      Selling Price: <input type="text" name="selling_price"> <br/>
      Weight: <input type="text" name="weight"> <br/>
      Picture Address (optional): <input type="text" name="picture"> <br/>
      Supplier ID (16 digits): <input type="text" name="supplier"> <br/>
