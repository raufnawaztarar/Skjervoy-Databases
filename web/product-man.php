...
<body>
  ...
  <form name="Add New Product" action="" method="post">
    Product ID (16 digits):<input type="text" name="product_id" value="<?php echo $new_id; ?>"> <br />
    ...
    Buying Price: <input type="text" name="buying_price" value="1.99"> <br />
    Selling Price: <input type="text" name="selling_price" value="899.99"> <br />
    Weight: <input type="text" name="weight" value="0.8"> <br />
    Picture Address (optional): <input type="text" name="picture" value="img/pen/none.jpg"> <br />
    <!-- Supplier ID (16 digits): <input type="text" name="supplier" value="0000000000000003"> <br /> -->
    Supplier: <select name="supplier">
      <option value="0000000000000003">Skjervoy</option>
      <option value="0000000000000002">Pilot</option>
      <option value="0000000000000001">Lamy</option>
    </select> <br />
