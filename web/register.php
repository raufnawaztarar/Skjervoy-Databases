...
<html>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
    ...
    <div class="black_box_desc_employee">
      <p class="center_box_heading_employee"><font face="javanese-text"->- Register -</font></p>
    </div>
    ...
    <div class="login-form">
      <form action="" method="post">      
          ...
          <div class="form-group">
              <input type="password" class="form-control" placeholder="Password" required="required" name="inpassword">
          </div>
          <div class="form-group">
    ...
    <div>
      ...
      if (isset($_POST['register'])) {
        ...
        $stmt = $mysql->prepare(
            ...
            ( `Customer ID`, Name, Address, Phone, Email, Password)
VALUE (:Customer_ID, :Name, :Address, :Phone, :Email, :Password)"
          );
